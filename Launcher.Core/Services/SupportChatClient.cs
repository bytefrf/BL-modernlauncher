...
{
    /// <summary>Адрес API обращений. Тот же, что использует кабинет на сайте.</summary>
    public const string DefaultEndpoint = "https://bl-modern.ru/api/support_tickets.php";
